...
export default function CarouselActivities({allTinerary}) {
    const activities = allTinerary.activities
...
<SafeAreaView style={styles.container}>
    ...
    <Animated.FlatList onScroll={Animated.event( [{ nativeEvent: { contentOffset: { x: scrollX } } }], {
        ...
        }} snapToInterval={ANCHO_CONTENEDOR} decelerationRate={0} scrollEventThrottle={16} data={activities}
        ...
        <View style={{ width: ANCHO_CONTENEDOR }}>
            <Animated.View style={{
                ...
                <Image source={{ uri: item.activitiesPhotos[0] }} style={styles.posterImage} />
                <Text style={{ fontWeight: "bold", fontSize: 25, color: '#A62D43',textShadowColor: '#F27E7E',textShadowRadius: 5, }}>
                    {" "}
                    {item.activitiesName}
                </Text>
            </Animated.View>
